import styles from "./main-post__style.module.scss"
import { PostType } from "../types"
import { openSelectedImg } from "../features/imagePost/imagePostSlice"
...
const MainPost = (props: PostType) => {
    ...
    const handleToggleFavorite = (post: PostType) => {
        if (favorites.some((favPost: PostType) => favPost.id === post.id)) {
        ...
        <div className={styles.main}>
            <div className={styles.main__textBlock}>
                ...
                <div className={styles.main__textSvg}>
                    <button className={styles.main__wrapperLike}><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                        ...
                        <button className={styles.main__wrapperDislike}><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
            ...
            <div className={styles.main__imgBlock}>
                ...
                <div className={styles.main__imgSvg}>
                    ...
                    {favorites.some((favPost: { id: any }) => favPost.id === props.id) ? <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="#363853">
                    ...
                    <button className={styles.main__wrapperOther}><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
