import style from "./addFavStyles.module.scss"

const AddFav = () => {
    return (
        <button className={style.wrapperAddBtn}>
            <div className={style.wrapperSvg}><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
            ...
            <p className={style.btnText}>Add to favorites</p>
        </button>
    )
}
