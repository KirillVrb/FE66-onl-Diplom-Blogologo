    ...
    return (
        <div className={styles.middle}>
            <div className={styles.middle__wrapperImg}>
                <img src={props.image} alt={props.image} className={styles.middle__img} />
            </div>
            <div className={styles.middle__description}>
                <p className={styles.middle__date}>{props.date}</p>
                <h2 className={styles.middle__title}>{props.title}</h2>
                {/* <div className={styles.middle__svg}>
                    <div className={styles.middle__svgLeft}>
                        <div className={styles.middle__wrapperLike}><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                        ...
                        <div className={styles.middle__wrapperDislike}><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                    ...
                    <div className={styles.middle__svgRight}>
                        <div className={styles.middle__wrapperSaved}><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                        ...
                        <div className={styles.middle__wrapperOther}><svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
